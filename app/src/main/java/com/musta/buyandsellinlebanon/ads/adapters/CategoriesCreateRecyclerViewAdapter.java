...
public class CategoriesCreateRecyclerViewAdapter extends RecyclerView.Adapter<CategoriesCreateRecyclerViewAdapter.MyViewHolder> {
    ...
    public CategoriesCreateRecyclerViewAdapter(List<CategoriesRVModel> categoriesRVModelList, Context context) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Constants.DOLLAR_MARKET.equals(categoriesRVModel.getValue())) {
                    Intent intent = new Intent(context, CreateDollarMarketActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(intent);
                } else {
                    Intent intent = new Intent(context, BeforeCreateAdActivity.class);
